...
<script>
    $(document).ready(function() {
        $.ajax({
            type: "POST",
            url: "http://localhost:8080/selaras/pelanggan/ongkir/provinsi",
        ...
        $("select[name=provinsi]").on("change", function() {
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost:8080/selaras/pelanggan/ongkir/kota",
        ...
        $("select[name=kota]").on("change", function() {
            $.ajax({
                type: "POST",
                url: "http://localhost:8080/selaras/pelanggan/ongkir/expedisi",
        ...
        $("select[name=expedisi]").on("change", function() {
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost:8080/selaras/pelanggan/ongkir/paket",
