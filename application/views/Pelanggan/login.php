        ...
        <div class="col-lg-6 mb-5">
            ...
            <div class="contact-form">
                ...
                <form action="<?= base_url('pelanggan/auth') ?>" method="POST">
                    ...
                    <p>Kamu belum memiliki akun? <a href="<?= base_url('pelanggan/auth/register') ?>" style="color: blue">Daftar Sekarang!</a></p>
                    <div>
                        <button type="submit" class="btn btn-secondary py-2 px-4" type="submit">Login</button>
                    </div>
                </form>
            </div>
        </div>
