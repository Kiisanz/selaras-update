        ...
        <div class="col-lg-6 mb-5">
            ...
            <div class="contact-form">
                ...
                <form action="<?= base_url('pelanggan/auth/register') ?>" method="POST">
                    ...
                    <div>
                        <p class="mt-3">Kamu sudah memiliki akun? <a href="<?= base_url('pelanggan/auth') ?>"style="color: blue">Masuk disini!</a></p>
                        <button class="btn btn-secondary py-2 px-4 mt-3" type="submit" id="sendMessageButton">Daftar</button>
                    </div>
                </form>
            </div>
        </div>
