                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                foreach ($produk as $key => $value) {
                                    $deskripsi_singkat = strlen($value->deskripsi) > 50 ? substr($value->deskripsi, 0, 50) . '...' : $value->deskripsi;
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?= $deskripsi_singkat ?></td>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                <!-- TinyMCE Editor -->
                                <textarea name="deskripsi" class="tinymce-editor"><?= set_value('deskripsi') ?></textarea>
                                <!-- End TinyMCE Editor -->
