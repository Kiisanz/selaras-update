	...
	<ul class="sidebar-nav" id="sidebar-nav">
		...
		<li class="nav-item">
			...
			<ul id="forms-nav" class="nav-content collapse <?php if ($this->uri->segment(1) == 'Admin' && $this->uri->segment(2) == 'KelolaDataMaster') {
				...
				<li>
					<a href="<?= base_url('Admin/KelolaDataMaster/add_voucher') ?>" <?php if ($this->uri->segment(1) == 'Admin' && $this->uri->segment(2) == 'KelolaDataMaster' && $this->uri->segment(4) == 'voucher') {
																						echo 'class="active"';
																					}  ?>>
						<i class="bi bi-circle"></i><span>Voucher Pelanggan</span>
					</a>
				</li>
				<li>
